...
<%
	...
	rs.open "Select Top 1 * From p8_Page Where ClassID in(42)",Conn,1,1
	...
	<div class="con_bg1">
		<div class="con">
			<div class="con_l left">
            	<h2><img src="images/tit5.gif" width="179" height="17" /></h2>
                <ul>
                	<li><a href="Business.asp" class="hover">民商诉讼业务</a></li>
                    <li><a href="gsyw.asp">公司业务</a></li>
                    <li><a href="#">证券业务</a></li>
                    <li><a href="#">国际业务</a></li>
                    <li><a href="#">刑事诉讼业务</a></li>
                    <li><a href="#">知识产权业务</a></li>
                </ul>
...
陈小姐：13632458845<br />传  真：020-87219960<br />E-mail：shijicheng@163.com <br />公司地址：湖南省大祥区云溪北路商务综合楼310室 </p></div>
    		...
    		<div class="con_r right">
            	<div class="title">
                	<span class="left"><img src="images/title5.gif" width="268" height="14" /></span>
                    <p class="right">您现在的位置：<a href="index.asp">首页</a>--<a href="Business.asp">业务领域</a>--<a href="Business.asp">民商诉讼业务</a></p>
  	  	  	  	</div>
                <div class="main7">
<%=rs("Content")%>
  		  		</div>
