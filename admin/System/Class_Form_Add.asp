...
<%
	...
	If Request("ClassName") <> "" Then
		...
		Set rs=Nothing
		CloseConn
		Response.Redirect "Class_Form_List.asp?Tip=添加成功！"
		Response.End()
  ...
  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
    <tr>
      <td height="25" colspan="2" bgcolor="#E4EDF9"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td>&nbsp;<span class="f14 cBlack">表单 - 增加表单</span></td>
    ...
    <tr>
	  ...
	  <input name="ParentID" type="hidden" value="0">
        <input name="ClassType" type="hidden" value="表单">
    ...
    <tr>
      ...
      <td bgcolor="#F8FBFE">
	  <div id="Field">	  </div>
	  <a href="#" class="AddBtn" onClick="openw('../System/Class_Form_Field.asp?Num=<%=Num%>','name1',800,500)">添加字段</a></td>
    </tr>
    <tr>
