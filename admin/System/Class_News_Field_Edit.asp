...
<%
	...
	If Request("FieldName") <> "" Then
		...
		CloseConn
		Response.Write "<script>alert(""修改成功"");window.close();window.opener.document.getElementById(""Fi"& id &""").innerHTML = ""<strong style='color:#009900;'>"& FieldName &"</strong>("& FieldType &")&nbsp;&nbsp;<a href='#' onclick=\""openw('../System/Class_News_Field_Edit.asp?Fiid="& id &"','name1',800,500)\"">修改</a>&nbsp;<a href='#' onclick='DelField("& id &")'>删除</a>"";</script>"
		Response.End()
...
<input name="id" type="hidden" value="<%=id%>">
  <tr>
    <td height="25" colspan="2" bgcolor="#E4EDF9">&nbsp;<span class="f14 cBlack">文章列表 - 修改字段</span></td>
  </tr>
  <tr>
