...
<%
	...
	If Request("ClassName") <> "" Then
		...
		Set rs=Nothing
		CloseConn
		Response.Redirect "Class_Pic_List.asp?Tip=添加成功！"
		Response.End()
  ...
  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
    <tr>
      <td height="25" colspan="2" bgcolor="#E4EDF9"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td>&nbsp;<span class="f14 cBlack">图片列表 - 增加分类</span></td>
      ...
      <td bgcolor="#F8FBFE" class="cBlack">
	  	<%
			...
			Else
				...
				rs_pre.open "Select id,ClassName From p8_Class Where ClassType = '图片' And ClassLevel = "& ClassLevel &"  Order By id Desc",Conn,1,1
			...
			End If
		%>
        <input name="ClassType" type="hidden" value="图片">
    ...
    <tr>
	  ...
	  <a href="#" class="AddBtn" onClick="openw('../System/Class_Pic_Field.asp?Num=<%=Num%>','name1',800,500)">添加字段</a></td>
    </tr>
    <tr>
