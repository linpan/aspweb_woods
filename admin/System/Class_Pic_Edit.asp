...
<%
	...
	If Request("ClassName") <> "" Then
		...
		Set rs=Nothing
		CloseConn
		Response.Redirect "Class_Pic_List.asp?Tip=修改成功！"
		Response.End()
...
function DelField(id){	
	obj = $Get("Fi"+ id +"");
	if(id){
		var DelUrl="Class_Pic_Field_Del.asp?id="+id;
...
<input name="id" type="hidden" value="<%=id%>">
  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
      ...
      <td bgcolor="#F8FBFE" class="cBlack">
	  	<%
			If ParentID = "" Or ParentID = "0" Then
				Response.Write "图片列表<input name=""ParentID"" type=""hidden"" value=""0"">"			
			Else
				Set rs_pre = Server.CreateObject("ADODB.RecordSet")
				rs_pre.open "Select id,ClassName From p8_Class Where ClassType = '图片' And ClassLevel = "& ClassLevel-1 &"  Order By id Desc",Conn,1,1
    ...
    <tr>
      ...
      <td bgcolor="#F8FBFE"><input name="ClassName" type="text" class="ipt4" id="ClassName" style="width:150px;" value="<%=ClassName%>" maxlength="80"></td>
    </tr>
    <tr>
    ...
    <tr>
		...
		<%
			...
			rsf.open "Select id,FieldName,FieldType From p8_Field Where ClassNum = '"& rs("Num") &"' Order By id Desc",Conn,1,1
				...
				Do While Not rsf.Eof 
						Response.Write "<div style=""padding:5px 0;"" id=""Fi"& rsf("id") &"""><strong style=""color:#009900;"">"& rsf("FieldName") &"</strong>("& rsf("FieldType") &")&nbsp;&nbsp;<a href=""#"" onclick=""openw('../System/Class_Pic_Field_Edit.asp?Fiid="& rsf("id") &"','name1',800,500)"">修改</a>&nbsp;<a href=""#"" onclick=""DelField("& rsf("id") &")"">删除</a></div>"
					rsf.MoveNext         
				Loop 
	  ...
	  <a href="#" class="AddBtn" onClick="openw('../System/Class_Pic_Field.asp?Num=<%=rs("Num")%>','name1',800,500)">添加字段</a></td>
    </tr>
    <tr>
