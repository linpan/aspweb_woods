...
<%
	...
	If Request("FieldName") <> "" Then
		...
		CloseConn
		Response.Write "<script>alert(""添加成功"");window.close();window.opener.document.getElementById(""Field"").innerHTML = ""<div style='padding:5px 0;' id='Fi"& Fiid &"'><strong style='color:#009900;'>"& FieldName &"</strong>("& FieldType &")&nbsp;&nbsp;<a href='#' onclick=\""openw('../System/Class_Pic_Field_Edit.asp?Fiid="& Fiid &"','name1',800,500)\"">修改</a>&nbsp;<a href='#' onclick='DelField("& Fiid &")'>删除</a></div>"" + window.opener.document.getElementById(""Field"").innerHTML;</script>"
		Response.End()
...
function VariableUse(){	
	if($Get("Variable").value){
		...
		var VariableUrl="Class_Pic_Field_Check.asp?ClassNum=<%=Request("Num")%>&Variable="+Variable;
...
<input name="Num" type="hidden" value="<%=Request("Num")%>">
  <tr>
    <td height="25" colspan="2" bgcolor="#E4EDF9">&nbsp;<span class="f14 cBlack">图片列表 - 添加字段</span></td>
  </tr>
  <tr>
