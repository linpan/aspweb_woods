...
function MakeCode(){
	...
	if(isPageStr == 1){ //如果选择了分页
		Code2 = "&lt;%\n"+ ClassVarStr1 +
				...
				"	rs.open \"Select * From p8_Pic Where 1=1 "+ ClassVarStr2 + bClassSql + sClassSql +" Order By "+ PaixuStr +" Desc\",Conn,1,1\n"+
				"	\n"+
				"	n = 1\n"+
		...
		Code2 = "&lt;%\n"+ ClassVarStr1 +
				"	Set rs = Server.CreateObject(\"ADODB.Recordset\")\n"+
				"	rs.open \"Select Top "+ RowCount +" * From p8_Pic Where 1=1 "+ ClassVarStr2 + bClassSql + sClassSql +" Order By "+ PaixuStr +" Desc\",Conn,1,1\n"+
				"	\n"+
				"	n = 1\n"+
    ...
    <tr>
      <td bgcolor="#F8FBFE"><table border="0" cellspacing="10" cellpadding="0">
        <tr>
          ...
          <td width="80" align="center" class="Tab1_over">图片列表</td>
      ...
      <td bgcolor="#F8FBFE" style="padding:10px;"><table width="100%" border="0" cellpadding="10" cellspacing="1" bgcolor="#E4EDF9">
          <tr>
            <td bgcolor="#FFFFFF" style="line-height:160%;"><strong>字段说明：<br>
              </strong><span class="cGray">名称 &lt;%=rs(&quot;PicName&quot;)%&gt;&nbsp;&nbsp;缩略图地址 &lt;%=rs(&quot;SmallPic&quot;)%&gt;&nbsp;&nbsp;内容 &lt;%=rs(&quot;Content&quot;)%&gt; 自定义字段 &lt;%=PicField(&quot;变量名&quot;,rs(&quot;id&quot;))%&gt; </span><br>
              <strong>循环内容范例：</strong><br>
              <span class="cGray"> &lt;div class=&quot;aPic&quot;&gt;&lt;a href=&quot;PicView.asp?id=&lt;%=rs(&quot;id&quot;)%&gt;&quot; target=&quot;_blank&quot;&gt;&lt;img src=&quot;&lt;%=rs(&quot;SmallPic&quot;)%&gt;&quot; width=&quot;120&quot; height=&quot;120&quot; /&gt;&lt;/a&gt;&lt;br /&gt;&lt;a href=&quot;PicView.asp?id=&lt;%=rs(&quot;id&quot;)%&gt;&quot; target=&quot;_blank&quot;&gt;&lt;%=rs(&quot;PicName&quot;)%&gt;&lt;/a&gt;&lt;/div&gt; (其中PicView.asp改成你的显示页文件名，如需并排图片，可设置aPic的样式为float:left;) </span><br>              
  ...
  <%
	...
	rs2.open "Select id,ClassName From p8_Class Where ClassType='图片' And ClassLevel=1 Order By id Desc",Conn,1,1
		...
		Do While Not rs2.Eof 
			...
			rs3.open "Select id,ClassName From p8_Class Where ClassType='图片' And ClassLevel=2 And ParentID="& rs2("id") &" Order By id Desc",Conn,1,1
...
<div id="ClassVarTr" style="display:none; margin-top:10px; border:1px solid #F9D751; line-height:180%; padding:10px; background-color:#FEF9E2; color:#A86500;">
 动态分类是将代码放在一个文件中，通过地址栏参数显示对应分类内容。格式如：PicList.asp?ClassID=3，其中“PicList.asp”可改成你的文件名，“3”改成对应分类ID，对照表如下，括号内为对应分类ID：<br>
<%
Set rs2 = Server.Createobject("Adodb.RecordSet")
rs2.open "Select id,ClassName From p8_Class Where ClassType='图片' And ClassLevel=1 Order By id Desc",Conn,1,1
...
<tr id="PageCountTr">
  ...
  <td bgcolor="#F8FBFE"><input name="PageCount" type="text" class="ipt3" id="PageCount" value="16" size="10" maxlength="5"></td>
</tr>
...
&lt;%
	Set rs = Server.CreateObject("ADODB.Recordset")
	rs.open "Select * From p8_Pic Order By AddDate Desc",Conn,1,1

	n = 1
	rs.PageSize = 16 '每页记录数
	tatalrecord = rs.RecordCount '总记录数
	tatalpages  = rs.PageCount '总页数
	page        = Request("page")
