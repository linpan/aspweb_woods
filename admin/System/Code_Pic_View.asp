...
function MakeCode(){
	...
	if(isPageStr == 1){ //如果选择了分页
		Code2 = "&lt;%\n"+
				...
				"	rs.open \"Select * From p8_Pic Where 1=1 "+ bClassSql + sClassSql +" Order By "+ PaixuStr +" Desc\",Conn,1,1\n"+
				"	\n"+
				"	n = 1\n"+
		...
		Code2 = "&lt;%\n"+
				"	Set rs = Server.CreateObject(\"ADODB.Recordset\")\n"+
				"	rs.open \"Select Top "+ RowCount +" * From p8_Pic Where 1=1 "+ bClassSql + sClassSql +" Order By "+ PaixuStr +" Desc\",Conn,1,1\n"+
				"	\n"+
				"	n = 1\n"+
    ...
    <tr>
      <td bgcolor="#F8FBFE"><table border="0" cellspacing="10" cellpadding="0">
        <tr>
          ...
          <td width="80" align="center" class="Tab1_over">图片显示</td>
