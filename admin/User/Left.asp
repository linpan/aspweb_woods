...
<table width="136" height="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td height="23" align="center" background="../images/Ti_bg.gif" style="border:1px solid #8db2e3; border-bottom:none; font-size:13px; padding-top:3px;"><strong>会员管理</strong></td>
  ...
  <tr>
	...
	<tr>
	  <td onMouseOver="this.className='Btn_over';" onMouseOut="this.className='Btn';" class="Btn" height="25"> <a href="SysUser_List.asp" target="main">网站管理员</a> | <a href="SysUser_Add.asp" target="main">添加</a></td>
	</tr>
        <tr>
          <td onMouseOver="this.className='Btn_over';" onMouseOut="this.className='Btn';" class="Btn" height="25"><a href="SysLog.asp" target="main">后台登录日志</a></td>
        </tr>
	<%End If%>
        <tr>
          <td onMouseOver="this.className='Btn_over';" onMouseOut="this.className='Btn';" class="Btn" height="25"><a href="User_List.asp" target="main">注册会员</a></td>
        </tr>
		<tr>
