...
<%
	...
	rs.open "Select Top 1 * From p8_Page Where ClassID in(44)",Conn,1,1
	...
	<div class="con_bg1">
		<div class="con">
			<div class="con_l left">
                ...
                <ul>
                	<li><a href="contact.asp" class="hover">联系方式</a></li>
                    <li><a href="messages.asp">在线留言</a></li>
                </ul>
              <div class="contact"><img src="images/contacttit.gif" width="224" height="70" /><p>客服热线：0739-5230760 5332900 付先生：13886760438<br />
陈小姐：13632458845<br />传  真：020-87219960<br />E-mail：shijicheng@163.com <br />公司地址：湖南省大祥区云溪北路商务综合楼310室 </p></div>
    		...
    		<div class="con_r right">
            	<div class="title">
                	<span class="left"><img src="images/title2.gif" width="158" height="14" /></span>
                    <p class="right">您现在的位置：<a href="index.asp">首页</a>--<a href="contact.asp">联系我们</a>--<a href="contact.asp">联系方式</a></p>
   		  	  	</div>
                <div class="main2">
                	<%=rs("Content")%>
       	  		</div>
