...
<%
	...
	rs.open "Select Top 1 * From p8_Page Where ClassID in(49)",Conn,1,1
	...
	<div class="con_bg1">
		<div class="con">
			<div class="con_l left">
                ...
                <ul>
                	<li><a href="Business.asp">民商诉讼业务</a></li>
                    <li><a href="gsyw.asp" class="hover">公司业务</a></li>
                    <li><a href="#">证券业务</a></li>
                    <li><a href="#">国际业务</a></li>
...
陈小姐：13632458845<br />传  真：020-87219960<br />E-mail：shijicheng@163.com <br />公司地址：湖南省大祥区云溪北路商务综合楼310室 </p></div>
    		...
    		<div class="con_r right">
            	<div class="title">
                	<span class="left"><img src="images/title9.gif" width="203" height="14" /></span>
                  <p class="right">您现在的位置：<a href="index.asp">首页</a>--<a href="Business.asp">业务领域</a>--<a href="gsyw.asp">公司业务</a></p>
  	  	  	  	</div>
                <div class="main7">
<%=rs("Content")%>
  		  		</div>
