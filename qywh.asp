...
<%
	...
	rs.open "Select Top 1 * From p8_Page Where ClassID in(47)",Conn,1,1
		...
		<div class="con">
			<div class="con_l left">
                ...
                <ul>
                    ...
                    <li><a href="qywh.asp" class="hover">企业文化</a></li>
...
陈小姐：13632458845<br />传  真：020-87219960<br />E-mail：shijicheng@163.com <br />公司地址：湖南省大祥区云溪北路商务综合楼310室 </p></div>
    		...
    		<div class="con_r right">
            	<div class="title">
                	<span class="left"><img src="images/title7.gif" width="135" height="13" /></span>
                  <p class="right">您现在的位置：<a href="index.asp">首页</a>--<a href="about.asp">关于我们</a>--<a href="qywh.asp">企业文化</a></p>
       		  	</div>
                <div class="main1">
<%=rs("Content")%>
           	  </div>
